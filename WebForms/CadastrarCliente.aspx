<%@ Page Title="Adicionar Novo Cliente" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CadastrarCliente.aspx.cs" Inherits="WebForm.CadastrarCliente" %>
        ...
        <div class="corrige-layout-telas">
            ...
            <div class="form-horizontal">
                ...
                <div class="container-inputs">
                    <div class="col-lg-2">
                        <asp:Label ID="LabelTeste" runat="server" CssClass="label-inputs"></asp:Label>
                ...
                <div class="container-inputs links-acao">
                    ...
                    <div>                        
                        <asp:Button ID="btnSubmit" runat="server" Text="Adicionar →" CssClass="retira-transform-text tamanho-links-acao btn btn-default" OnClick="btnSubmit_Click" />
                    </div>
                </div>
            </div>
